...
TableInvests.forEach(B =>{
    ...
    B.children[2].addEventListener("click", ()=>{
        ...
        putInvest.children[1].children[2].children[1].textContent = B.children[1].children[2].children[0].textContent.substring(0, B.children[1].children[2].children[0].textContent.length-1) + " Heur(s)";

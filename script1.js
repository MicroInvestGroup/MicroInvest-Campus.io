...
const inputPassWord = BodyInscr.children[3];
    ...
    ValidateBtn.addEventListener("click", async () => {
        ...
        if(regexEmail.test(inputEmail.value)){         // email verification //
            if(regexNum.test(inputNum.value)){          // Number verification //
                ...
                Notifs.push(
                    "bien vouloir respecter la structure minimale d'un Numero de télèphone au cameroun !!,<br> le numero saisit n'est pas correct 🔴"
                )
            }
        }else{
                Notifs.push(
